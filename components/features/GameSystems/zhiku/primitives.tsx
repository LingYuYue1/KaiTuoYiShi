...
export function StructuredFlag({ label, checked, editable, onChange }: { label: string; checked?: boolean; editable: boolean; onChange: (checked: boolean | undefined) => void }) {
  return (
    <label className="flex min-w-0 items-center justify-between gap-2 px-3 py-2" style={{ background: 'rgba(var(--tj-bubble),0.48)', border: '1px solid rgba(var(--tj-border), var(--tj-edge-weak))', clipPath: smallClip }}>
