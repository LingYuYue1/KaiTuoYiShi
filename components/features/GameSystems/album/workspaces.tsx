...
export function QueueWorkspace({ tasks, onRetry }: { tasks: 图片生成任务[]; onRetry: (task?: 图片生成任务) => void }) {
...
export function QueueHero({ stats }: { stats: { active: number; failed: number; success: number; total: number } }) {
  return (
...
export function HistoryWorkspace({ album, assetMap, onSelect }: { album: 相册系统; assetMap: Map<string, { dataUrl?: string; url?: string; localRef?: string }>; onSelect: (id: string) => void }) {
