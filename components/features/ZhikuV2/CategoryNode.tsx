...
export const CategoryNode = forwardRef<HTMLButtonElement, CategoryNodeProps>(function CategoryNode(
  ...
  return (
    ...
    >
      <span className="zhiku-v2-node__emblem" aria-hidden="true">
        <span className="zhiku-v2-node__orbit zhiku-v2-node__orbit--outer" />
        <span className="zhiku-v2-node__orbit zhiku-v2-node__orbit--inner" />
        <span className="zhiku-v2-node__diamond" />
        <span className="zhiku-v2-node__decode">010110100100100101001011010101010011000100110000</span>
        <span className="zhiku-v2-node__icon" />
        <span className="zhiku-v2-node__spark zhiku-v2-node__spark--a" />
        <span className="zhiku-v2-node__spark zhiku-v2-node__spark--b" />
      </span>
      <span className="zhiku-v2-node__copy">
