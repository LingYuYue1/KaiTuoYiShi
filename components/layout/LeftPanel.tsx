...
export function LeftPanel({
  ...
  return (
    <div
      className="relative hidden md:flex md:w-[16%] min-w-[200px] max-w-[240px] flex-col"
      style={{
        background:
      ...
      <div className="flex flex-1 flex-col overflow-y-auto p-4">
        ...
        >
          ...
          <div className="relative">
            <div
              className="flex h-[88px] w-[88px] items-center justify-center font-serif text-4xl font-bold transition-all group-hover:scale-[1.03]"
              style={{
                background:
            ...
            <span
              ...
              style={{ color: 'rgba(245, 217, 122, 0.8)', textShadow: '0 0 6px rgba(245, 217, 122, 0.6)' }}
            >
              ✦
            </span>
            <span
              className="absolute -bottom-1.5 -left-1.5 text-base"
              style={{ color: 'rgba(245, 217, 122, 0.45)' }}
            >
              ◆
            </span>
          </div>
        ...
        <button
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(245, 217, 122, 0.08), rgba(245, 217, 122, 0.025))',
        ...
        >
          <span className="flex items-center gap-2">
            <span className="font-serif text-base" style={{ color: '#f5d97a' }}>▣</span>
            <span className="font-serif text-[13px] font-semibold tracking-[0.22em]" style={{ color: 'rgba(245, 217, 122, 0.92)' }}>
              手机
            </span>
          </span>
          {phoneUnread > 0 && (
        ...
        {currentStoryChapter && (
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(117,214,216,0.07), rgba(245,217,122,0.04))',
          ...
          >
            ...
            <div className="mt-1 line-clamp-2 text-[12px] leading-relaxed" style={{ color: 'rgba(235,223,193,0.9)' }}>
              {currentStoryChapter}
            </div>
          </div>
        )}
...
function InfoLine({ label, value }: { label: string; value: string }) {
  return (
    <div
      className="px-3 py-2"
      style={{
        background: 'rgba(245, 217, 122, 0.045)',
        boxShadow: 'inset 0 0 0 1px rgba(245, 217, 122, 0.22)',
        clipPath:
          'polygon(6px 0, 100% 0, 100% calc(100% - 6px), calc(100% - 6px) 100%, 0 100%, 0 6px)',
      }}
    >
      <div className="font-serif text-[11px] tracking-[0.32em]" style={{ color: 'rgba(245, 217, 122, 0.68)' }}>
        ◆ {label}
      </div>
      <div className="mt-1 truncate font-serif text-[13px] font-semibold tracking-[0.12em]" style={{ color: 'rgba(230, 218, 188, 0.95)' }}>
        {value}
      </div>
    </div>
  );
