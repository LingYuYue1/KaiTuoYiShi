...
export function buildVariableModelPrompt(
  ...
  return [
    ...
    '- 新 NPC 与已有 NPC 都只写事实；系统会决定 push 新档案还是更新旧档案。',
    '- 新出现的原著角色、具名重要角色、直接与玩家互动并留下可承接记忆的角色，tier 写 companion；只露面一次、没有姓名或没有后续承接价值的路人/敌兵才写 extra 或不写 npc。',
    ...
    '- path 必须出现在下面登记表中。',
    '- delete 可省略值。',
    '- 兼容命令不得用于 time / location / npc / item / world_event / phone_seed / traveler_profile 能表达的事实。',
    '',
    '## thinking 输出规范',
    '',
