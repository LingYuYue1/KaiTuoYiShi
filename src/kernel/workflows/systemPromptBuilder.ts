...
import { buildStoryWeavingInjection } from '@/src/kernel/workflows/storyWeaving';
import {
...
export function buildSystemPrompt(
  ...
  const effectiveModules = settings.promptModules.filter((module) => !isSTImportedModule(module));
