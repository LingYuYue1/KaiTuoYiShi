...
export function useGame(): UseGameReturn {
  ...
  // 组装逻辑统一收敛到 createInitialWorkspace（services/newGameInitialization.ts，
  // GitHub #15）；这里只保留 beginSession 时序、setter 投影、持久化与 checkpoint 编排。
  ...
  // 组装逻辑统一收敛到 createInitialWorkspace（services/newGameInitialization.ts，GitHub #15）；
