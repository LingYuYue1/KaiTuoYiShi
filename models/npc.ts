...
function 合并NPC记录(base: NPC记录, incoming: NPC记录): NPC记录 {
  ...
  return {
    ...
    阵营ID: preferred.阵营ID ?? base.阵营ID ?? incoming.阵营ID,
...
export function 读取NPC头像(record: Pick<NPC记录, '头像' | '图像档案'> | undefined, slot: NPC头像槽位 = '档案'): string | undefined {
