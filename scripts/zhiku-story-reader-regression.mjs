...
const reader = read('components/features/ZhikuV2/StoryArchiveReader.tsx');
const css = read('components/features/ZhikuV2/story-archive-reader.css');
...
requireText(reader, 'zhiku-v2-story-reader__archive-group', 'two-level archive tree');
...
requireText(reader, 'zhiku-v2-story-reader__reading-pane', 'scrolling novel reader');
...
requireText(css, '.zhiku-v2-story-reader__archive-button', 'archive filename row');
requireText(css, '.zhiku-v2-story-reader__chapter-title', 'chapter nickname heading');
