...
assert(variableModel.includes('affinityDelta / affinitySet 的审计一视同仁'), '变量模型应包含性别中性的好感审计提醒。');
assert(variableModel.includes('"npc_danheng"') && variableModel.includes('"affinityDelta":2') && variableModel.includes('丹恒在玩家按约带回星核调查线索后'), '变量模型应包含男性 NPC 好感示例。');
