...
const albumWorkspaceLogic = read('components/features/GameSystems/album/albumWorkspaceLogic.ts');
const albumPanel = read('components/features/GameSystems/AlbumPanel.tsx');
assert.ok(albumWorkspaceLogic.includes('mountSrc?: string'), 'character library entries must separate display URLs from persisted references');
assert.ok(albumWorkspaceLogic.includes('mountSrc: candidate.reference'), 'built-in avatar entries must expose their logical mount reference');
...
const resilientSurfaces = [
  'components/features/GameSystems/album/workspaceComponents.tsx',
  'components/features/GameSystems/companion/primitives.tsx',
  'components/features/GameSystems/companion/npcDetail.tsx',
  'components/features/Phone/primitives.tsx',
  'components/features/Chat/MessageRenderers.tsx',
  'components/features/Chat/userTurnBubble.tsx',
...
console.log('Static avatar canary regression passed: manifest, resolver, resilient surfaces, and retired local PNGs are all consistent.');
