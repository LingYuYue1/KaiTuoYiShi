...
const css = read('components/features/ZhikuV2/zhiku-v2.css');
...
requireText(experience, '<ZhikuPanel', 'legacy maintenance workbench preservation');
...
requireText(css, '.zhiku-v2-maintenance__content', 'full-screen maintenance surface');
