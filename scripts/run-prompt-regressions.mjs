...
const SCRIPTS = [
  ...
  'variable-coverage-regression.mjs',
  'variable-calibration-context-regression.mjs',
  'variable-prompt-contract-regression.mjs',
  'variable-fact-discriminator-regression.mjs',
