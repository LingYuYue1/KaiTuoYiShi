...
assert(apiSettings.includes('variableApi: { ...gameSettings.variableApi, model }'), '其他 API 模型设置必须覆盖变量模型。');
assert(apiSettings.includes('新闻系统: { ...gameSettings.新闻系统, api: { ...gameSettings.新闻系统.api, model } }'), '其他 API 模型设置必须覆盖新闻模型。');
assert(apiSettings.includes('手机系统: { ...gameSettings.手机系统, api: { ...gameSettings.手机系统.api, model } }'), '其他 API 模型设置必须覆盖手机模型。');
assert(apiSettings.includes('智库系统: { ...gameSettings.智库系统, api: { ...gameSettings.智库系统.api, model } }'), '其他 API 模型设置必须覆盖智库模型。');
assert(apiSettings.includes('剧情编织系统: { ...gameSettings.剧情编织系统, api: { ...gameSettings.剧情编织系统.api, model } }'), '其他 API 模型设置必须覆盖剧情编织模型。');
assert(apiSettings.includes('记忆总结API: { ...gameSettings.记忆系统.记忆总结API, model }'), '其他 API 模型设置必须覆盖记忆总结模型。');
assert(apiSettings.includes('忆庭召回API: { ...gameSettings.记忆系统.忆庭召回API, model }'), '其他 API 模型设置必须覆盖忆庭召回模型。');
assert(apiSettings.includes('忆庭精炼API: { ...gameSettings.记忆系统.忆庭精炼API, model }'), '其他 API 模型设置必须覆盖忆庭精炼模型。');
