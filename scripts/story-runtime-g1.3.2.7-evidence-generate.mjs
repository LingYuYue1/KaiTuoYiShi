// G1.3.2.7 证据生成器（允许命名：story-runtime-g1.3.2.7-*；不是隐藏 runner）。
// - 直接运行白名单内明确列出的脚本（本包 6 条 + G1.3.2.6 5 条 + G1.3.2.5 7 条 + G1.3.2.4 6 条 +
//   G1.3.2.3 5 条 + G1.3.2.2 7 条 + G1.3.2.1 6 条 + G1.3.2 §9.1/9.2/9.3 31 条 = 73 条）；
...
const DIR = 'docs/superpowers/specs/2026-08-09-g1.3.2.7-evidence';
...
{
  const idxName = 'story-runtime-g1.3.2.7-evidence-index-regression';
